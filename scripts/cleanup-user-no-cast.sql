-- Cleanup script to remove user with email 'jenkinsj251@gmail.com'
-- This version avoids UUID casting entirely
...
BEGIN
    ...
    IF user_id_val IS NOT NULL THEN
        ...
        -- Delete comments
        DELETE FROM comments WHERE author_id::TEXT = user_id_val;
        RAISE NOTICE 'Deleted comments for user %', user_id_val;
        
        -- Delete threads
        DELETE FROM threads WHERE author_id::TEXT = user_id_val;
